...
||| |v| ||| |v| ACROSS EACH ROW
|^| ||| |^| ||| IN THIS MANNER
||| |v| ||| |v| LAST ROW IS FILLED WITH DUMMY WORDS
___ ___ ___ ___
Start       End
...
def main():
    ...
    # split elements ito words, not letters
...
def validate_col_row(cipherlist):
    """Check that input colums & rows are valid vs. message length."""
    factors = []
...
def build_matrix(key_int, cipherlist):
    ...
    for k in key_int:
        ...
        elif k > 0: # read top-top-bottom of column
